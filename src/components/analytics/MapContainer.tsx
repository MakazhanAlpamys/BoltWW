...
import { useMap as useAnalyticsContext } from '../../providers/AnalyticsProvider';
...
function MapController() {
  const map = useMap();
  const { analysisData } = useAnalyticsContext();
...
export function MapContainer({ children, className = '' }: MapContainerProps) {
  const { analysisData, isLoading, error } = useAnalyticsContext();
